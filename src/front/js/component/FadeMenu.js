        ...
        <div className="d-flex align-items-center">
            ...
            <div>
                ...
                <Menu
                    ...
                    className="mt-4"
                >
                    {/* Renderización condicional directamente dentro del Menu */}
                    {token && (
                        <MenuItem className="custom-menu-item" onClick={handleClose}>
                            <Link to="/profile"><i className="fa-regular fa-user"></i> Mi perfil</Link>
                        </MenuItem>
                    )}
                    {token && (
                        <MenuItem className="custom-menu-item" onClick={handleClose}>
                    ...
                    {!store.token ? (
                        [
                            <MenuItem key="login" className="custom-menu-item" onClick={handleClose}>
                                <Link to="/user-login"><i className="fa-solid fa-arrow-right-to-bracket"></i> Iniciar Sesión</Link>
                            </MenuItem>,
                            <MenuItem key="register" className="custom-menu-item" onClick={handleClose}>
                                <Link to="/register"><i className="fa-solid fa-user-plus"></i> Registrarse</Link>
                            </MenuItem>
                        ]
                    ) : (
