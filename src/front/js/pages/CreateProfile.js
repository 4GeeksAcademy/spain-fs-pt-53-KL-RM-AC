...
export const CreateProfile = () => {
    ...
    return (
        ...
        <div className="createProfile">
            {loading ? ( // Muestra el spinner mientras los datos se están cargando
                <div className="spinner-border text-primary" role="status">
                    <span className="visually-hidden">Cargando...</span>
                </div>
            ) : (
                <div className="container mt-2 p-3 justify-content-center">
                    <h3 className="text-center titleCreateProfile">Crear Perfil</h3>
                    <form className="d-flex">
                        <div className="form-group imageGroup col-4">
                        ...
                        <div className="container inputsCreateProfile">
                            <div className="container titleCreateProfile">
